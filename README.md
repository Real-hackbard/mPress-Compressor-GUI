...
![Discription](https://github.com/user-attachments/assets/4a778202-1072-463a-bfa3-842226e300af) <img src="https://github.com/user-attachments/assets/4e7de541-7d3a-422b-bdf2-781c2b3e6c73" />  
![Last Update](https://github.com/user-attachments/assets/e1d05f21-2a01-4ecf-94f3-b7bdff4d44dd) <img src="https://github.com/user-attachments/assets/f3af8382-ed9c-4a0b-8f1e-62764a6e1212" />  
...
* Optional [LZMA](https://www.7-zip.org/) compression
...
* Command line interface allows to use MPRESS from a [batch](https://en.wikipedia.org/wiki/Batch_file) or from a make file
...
```If the links doesn't work, right mouse button "Save target as".```
